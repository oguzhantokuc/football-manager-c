...
void Leauge::setLeauge(string name = "-", int num = 1, string team = "-") {
	...
	//	teamList[5]={"BASAKSEHIR",BASAKSEHIR,5};
	//	teamList[6]={"GOZTEPE",GOZTEPE,5};
	//	teamList[7]={"DENIZLISPOR",DENIZLISPOR,5};
	//	teamList[8]={"RIZESPOR",RIZESPOR,5};
	//	teamList[9]={"SIVASSPOR",SIVASSPOR,5};
	//	teamList[10]={"ALANYASPOR",ALANYASPOR,5};
	chooseTeam(team);
}
